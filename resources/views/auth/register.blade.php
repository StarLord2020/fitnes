                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="surname" class="col-md-4 col-form-label text-md-right">{{ __('Фамілія') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-md-4 col-form-label text-md-right">{{ __('Номер телефону') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('Стать') }}</label>
                            <div class="col-md-6">
                                <select
                                    required
                                    autocomplete="sex"
                                ...
                                >
                                    <option selected  value="none">Виберіть стать</option>
                                    <option value="Мужчина">Чоловіча</option>
                                    <option value="Женщина">Жіноча</option>
                                </select>
                                @error('sex')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>

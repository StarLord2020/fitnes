    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <div class="col-lg-4 col-md-4 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4 ml-md-4 d-flex justify-content-end">
                    <div>
            ...
            <div class="col-lg-5 col-md-5 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4 d-flex justify-content-end">
                    <div class="w-75">

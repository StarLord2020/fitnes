    ...
    <div class="formContainer">
        <div class="form_container">
            <form  ref="program" class="form-horizontal" role="form" id="form" @submit.prevent="sendProgram">
                <div class="row">
                    <span class="d-block mb-4 title">Редагування програми</span>
                </div>
                <div class="form-group">
                    <div class="row mb-3">
                        <div class="col-sm-4 d-flex align-items-center">Зображення</div>
                        <div class="col-sm-8 d-flex justify-content-end">
                            <avatar-load :src="program.image" :update="true"></avatar-load>
                        </div>
                    </div>
                    <div class="row">
            ...
            sendProgram(){
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        axios.post('/admin/program-update/'+this.program.id,data,
                            {
                                headers: {
